...
\input{B_Chapters/02_Related_work}
\input{B_Chapters/03_Fundamentals}
\input{B_Chapters/04_Methodology}
\input{B_Chapters/05_Prototype}
\input{B_Chapters/06_Evaluation_interpretation}
\input{B_Chapters/07_Discussion}
\input{B_Chapters/08_Conclusion}
