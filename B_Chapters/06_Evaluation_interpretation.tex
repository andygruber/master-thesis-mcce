...
CPU delta rises from near-idle or slightly negative baselines to approximately 5.4--5.5\% on both platforms.
The negative delta values for Windows sequential execution ($-$0.96\% CPU, $-$102.83 MB memory) indicate system resource usage decreased during test execution compared to the pre-benchmark baseline, likely due to background processes completing or system services releasing resources.
