...
Due to the extreme performance penalty observed, only a single exploratory benchmark run was conducted to quantify this penalty; these results should be interpreted as indicative rather than statistically robust.
