...
For CPU-bound compilation, all configurations performed within 15\% of each other, with native Linux containers imposing negligible overhead.
Compiler caching amplified differences: Linux containers achieved 24--28$\times$ speedup versus 4--5$\times$ on Windows.
