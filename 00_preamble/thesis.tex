...
\usepackage{pdflscape} % Landscape pages with rotated PDF view
...
\usepackage{currfile} % provides \currfiledir for automatic path detection
...
\usepackage[justification=centering,singlelinecheck=false,font=footnotesize]{caption} % Needed to format captions to center
